...
$loc_host = isset($_SESSION["source"]["hostname"]) ? $_SESSION["source"]["hostname"] : ( isset($cfg_source[0]) ? $cfg_source[0]["hostname"] : "10.4.1.1" );
$loc_user = isset($_SESSION["source"]["username"]) ? $_SESSION["source"]["username"] : ( isset($cfg_source[$idx = isset($_SESSION["source"]["hostname"]) && is_numeric($_SESSION["source"]["hostname"]) ? $_SESSION["source"]["hostname"] : 0]) && isset($cfg_source[$idx]["username"]) ? $cfg_source[$idx]["username"] : "root" );
$loc_pass = isset($_SESSION["source"]["password"]) ? $_SESSION["source"]["password"] : ( isset($cfg_source[$idx = isset($_SESSION["source"]["hostname"]) && is_numeric($_SESSION["source"]["hostname"]) ? $_SESSSION["source"]["hostname"] : 0]) && isset($cfg_source[$idx]["password"]) ? $cfg_source[$idx]["password"] : "c9P0tac" );
